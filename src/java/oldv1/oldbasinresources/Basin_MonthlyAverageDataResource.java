...
@Path("/basin/mavg")
public class Basin_MonthlyAverageDataResource {

    private String numbersPattern = "[0-9]{1,}";
    private Pattern p = null;
    private Logger log = Logger.getLogger(Basin_MonthlyAverageDataResource.class.getName());
    ...
    public Response getMonthlyDataBasin(
        ...
        return getMonthlyDataBasinDelegate(gcmName, scenarioName, statName, fyear, tyear, wbhuc, MediaType.APPLICATION_JSON);
    }
    ...
    @GET
    @Path("/{scenario}/{stat}/{fyear}/{tyear}/{wbhuc : (?i)\\d{1,6}(\\.\\w{3,5}|\\.\\w{3,5})?}")
    ...
    @GET
    @Path("/ensemble/{scenario}/{stat}/{fyear}/{tyear}/{percentile}/{wbhuc : (?i)\\d{1,6}(\\.\\w{3,5}|\\.\\w{3,5})?}")

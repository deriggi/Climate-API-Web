 ...
 */
@Path("/manom")
public class P_MonthlyAnomDataResource {

    private static final Logger log = Logger.getLogger(P_MonthlyAnomDataResource.class.getName());
    ...
    private Response getMonthlyDataIsoDelegate(String gcmName, String scenarioName, String statName, int fyear, int tyear, String iso3, String format) {
    ...
    public Response getMonthlyStatsRangeCountry(
        ...
        if (iso3 != null && (iso3.contains(ResponseConstants.xml) || iso3.contains(ResponseConstants.XML))) {
            return getMonthlyStatsRangeCountryDelegate(gcmName, scenarioName, statName, fyear, tyear, iso3, MediaType.APPLICATION_XML);
        }
        return getMonthlyStatsRangeCountryDelegate(gcmName, scenarioName, statName, fyear, tyear, iso3, MediaType.APPLICATION_JSON);
    }

...
$(document).ready(function(){
    ...
    $('#showdata').click(function(){
        ...
        getOldData(stattype,gcm, scenario, climvar, yearParts[0].trim(), yearParts[1].trim(), chosenIso);
    });
    $('#downloaddata').click(function(){
        ...
        downloadGcmData( stattype,gcm, scenario, climvar, yearParts[0].trim(), yearParts[1].trim(), chosenIso);
    })
    testCountriesSvg();
})
